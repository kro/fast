...
public class OrderExecutedLongForm extends SequenceTemplate {
  public static final OrderExecutedLongForm TEMPLATE = new OrderExecutedLongForm();

  protected OrderExecutedLongForm() {
